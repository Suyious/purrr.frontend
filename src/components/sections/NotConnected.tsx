    ...
    return (
        <section className="w-full h-full flex justify-center items-center">
            <div className="text-center flex flex-col items-center">
                ...
                <Image className="w-auto h-auto light:hidden" src="/mascot.png" width="100" height="100" alt="purrr.chat Mascot"/>
                ...
                <Image className="w-auto h-auto light:hidden" src="/logo.png" width="200" height="200" alt="purrr.chat Logo"/>
